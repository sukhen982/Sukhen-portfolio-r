    ...
    <section id="videos" className="relative py-24 bg-[#070B14] border-t border-cyan-500/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#0D1424] border border-purple-500/30 text-purple-300 text-xs font-mono mb-3">
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-14 h-14 rounded-full bg-purple-600/90 text-white flex items-center justify-center shadow-[0_0_25px_rgba(124,58,237,0.7)] group-hover:scale-110 group-hover:bg-cyan-400 group-hover:text-black transition-all duration-300">
        ...
        {/* Video Showcase CTA */}
        <div className="p-8 rounded-2xl bg-gradient-to-r from-purple-950/40 via-[#0D1424] to-cyan-950/40 border border-purple-500/30 shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-6">
